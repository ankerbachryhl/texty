    ...
    GraphQLServer.prototype.start = function (optionsOrCallback, callback) {
        ...
        return new Promise(function (resolve, reject) {
            var server = _this.options.https ?
                https_1.createServer(_this.options.https, app) : http_1.createServer(app);
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    connection.formatResponse = function (value) { return (__assign({}, value, { errors: value.errors && value.errors.map(_this.options.formatError || defaultErrorFormatter_1.defaultErrorFormatter) })); };
                                    _b.label = 1;
                                case 1:
                                    _b.trys.push([1, 5, , 6]);
