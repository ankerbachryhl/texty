...
export declare function graphiqlLambda(options: GraphiQL.GraphiQLData | LambdaGraphiQLOptionsFunction): (event: any, lambdaContext: lambda.Context, callback: lambda.Callback) => void;
